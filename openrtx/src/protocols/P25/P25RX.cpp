...
void CP25RX::processHdr(q15_t sample)
{
	...
	//		m_synced = true;
			...
			frame[0U] = 0x11U;
			validData = true;
	//		vcom_writeBlock((void*)"HDR\n", 4);
		}
		break;
		case P25_DUID_LDU1:
		case P25_DUID_LDU2:
			m_state   = P25RXS_LDU;
	//		vcom_writeBlock((void*)"LDU\n", 4);
			 break;
		case P25_DUID_PDU: {
